...
public class PannelloBase {
	...
	//private final static int TEMPO_DEFAULT = 3000;
	...
	public void aggiornare(Scenario sc) {
		/*
		if((this.stato == Stato.ABBATTUTO)&&(System.currentTimeMillis() - tempo  >= TEMPO_DEFAULT)) {
			this.stato = Stato.SOLLEVATO;
			tempo = 0;
		}
		*/
	...
	public LinkedList<ContributoGioco> catturare(Scenario sc){
		...
		LinkedList<Elemento> elementosARespawnear = new LinkedList<Elemento>();
